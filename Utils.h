 ...
 *
 *  TODO:
 *  (1) Optimizing Newton's method with better initial guess - using interpolation
 *  (2) Implement generic Cholesky decomposition to decorrelate the Brownian motions
...
public:
     ...
     */
    static double sampleCIR(double kappa, double vbar, double sigma, double v_s, double s, double t, std::default_random_engine& randomEngine);
